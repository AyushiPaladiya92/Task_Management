...
const UserList = ({ setTeam, team }) => {
  const data = summary.users || []; // Ensure data is always an array
  ...
  }, [team, data]); // Add data as a dependency
    ...
    <div>
      ...
      <Listbox value={selectedUsers} onChange={handleChange} multiple>
        <div className='relative mt-1'>
          <Listbox.Button className='relative w-full cursor-default rounded bg-white pl-3 pr-10 text-left py-2.5 border border-gray-300 sm:text-sm'>
